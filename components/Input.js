...
//                 </label>
//                 <button type="submit" className="submit-btn" onClick={addNewTopic}>Submit</button>
//             </form>
            
//             {/* <div className="content">
//                 <button className="absolutBtn">
