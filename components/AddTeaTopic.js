...
function AddTeaTopic() {
    ...
    return (
        <div className="voteLayout">
            ...
            <button onClick={() => setUpvotes(upvotes + 1)} className="upvoteBtn">
            ...
            <button onClick={() => setDownVote(downvotes + 1)} className="downVoteBtn">
