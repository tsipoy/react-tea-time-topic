...
function TeaTopicList({ topic }) {
    const [increaseCount, setIncreaseCount] = useState(topic.upvotes);
    const [decreaseCount, setDecreaseCount] = useState(topic.downvotes);
